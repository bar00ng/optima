              ...
              <table class="table align-items-center justify-content-center mb-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align-middle"><div class="dropdown"> <a href="#" class="btn btn-link text-secondary mb-0" data-bs-toggle="dropdown" id="navbarDropdownMenuLink2"><i class="fa fa-ellipsis-v text-xs"></i></a>
                  ...
                  <tr>
                    ...
                    <td class="align-middle"><div class="dropdown"> <a href="#" class="btn btn-link text-secondary mb-0" data-bs-toggle="dropdown" id="navbarDropdownMenuLink3"><i class="fa fa-ellipsis-v text-xs"></i></a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                          <li> <a class="dropdown-item" href="#">Konstruksi</a></li>
                          <li> <a class="dropdown-item" href="#">GoLive ODP</a></li>
                        </ul>
                  ...
                  <tr>
                    ...
                    <td class="align-middle"><div class="dropdown"> <a href="#" class="btn btn-link text-secondary mb-0" data-bs-toggle="dropdown" id="navbarDropdownMenuLink4"><i class="fa fa-ellipsis-v text-xs"></i></a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                          <li> <a class="dropdown-item" href="#">Konstruksi</a></li>
                          <li> <a class="dropdown-item" href="#">GoLive ODP</a></li>
                        </ul>
                  ...
                  <tr>
                    ...
                    <td class="align-middle"><div class="dropdown"> <a href="#" class="btn btn-link text-secondary mb-0" data-bs-toggle="dropdown" id="navbarDropdownMenuLink5"><i class="fa fa-ellipsis-v text-xs"></i></a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                          <li> <a class="dropdown-item" href="#">Konstruksi</a></li>
                          <li> <a class="dropdown-item" href="#">GoLive ODP</a></li>
                        </ul>
                  ...
                  <tr>
                    ...
                    <td class="align-middle"><div class="dropdown"> <a href="#" class="btn btn-link text-secondary mb-0" data-bs-toggle="dropdown" id="navbarDropdownMenuLink6"><i class="fa fa-ellipsis-v text-xs"></i></a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                          <li> <a class="dropdown-item" href="#">Konstruksi</a></li>
                          <li> <a class="dropdown-item" href="#">GoLive ODP</a></li>
                        </ul>
                  ...
                  <tr>
                    ...
                    <td class="align-middle"><div class="dropdown"> <a href="#" class="btn btn-link text-secondary mb-0" data-bs-toggle="dropdown" id="navbarDropdownMenuLink7"><i class="fa fa-ellipsis-v text-xs"></i></a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                          <li> <a class="dropdown-item" href="#">Konstruksi</a></li>
                          <li> <a class="dropdown-item" href="#">GoLive ODP</a></li>
                        </ul>
