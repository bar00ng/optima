                ...
                <div class="card-body px-5 py-2">
                    <form method="POST" action="{{ route('lop.storeFormSurvey') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_permintaan" id="namaPermintaan" value="{{ '[' . $lop->listPermintaan->tematik_permintaan . '] ' . $lop-listPermintaan->nama_permintaan }}" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                @if ($errors->has('rab_ondesk'))
                                    <input type="text" class="form-control is-invalid" name="rab_ondesk" value="{{ old('rab_ondesk') }}">
                                @else
